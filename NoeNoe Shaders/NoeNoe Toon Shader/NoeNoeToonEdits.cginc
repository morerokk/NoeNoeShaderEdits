...
float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
	...
	// If point or spot light, calculate the light direction
...
////// Lighting:
    ...
    if(_ReceiveShadows == 0)
    {
        ...
        attenuation = SHADOWLESS_LIGHT_ATTENUATION(i);
    }
    ...
    float3 FlatLighting = saturate((FlatLightSH( float3(0,0,0) )+(_LightColor0.rgb*attenuation)));
